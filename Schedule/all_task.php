...
$sql = "SELECT * FROM class c INNER JOIN class_affi a ON c.class_id = a.class_id WHERE member_id = '". $_COOKIE['id'] ."'";
		...
		<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent.php">
			  <input type="hidden" name="tsak_id" value="all_task">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <select name="task" class="form-control" id="task">
					  	<optgroup label="クラスタスク">
						<?php foreach ($class as $key => $value) :?>
							<option value="<?php echo $class[$key]["class_id"]; ?>,c"><?php echo $class[$key]["class_name"]; ?></option>
						<?php endforeach; ?>
						</optgroup>
						...
						<optgroup label="個人タスク">
						<option value="s,s" selected>個人タスク</option>
						</optgroup>
						</select>
					</div>
				  </div>
